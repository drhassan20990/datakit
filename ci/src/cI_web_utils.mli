...
val server :
  ...
  session_backend:[< `Memory
                  | `Redis of Redis_lwt.Client.connection Lwt_pool.t ] ->
...
class virtual post_page :
  server
  -> object
       inherit protected_page

       method content_types_accepted :
         ( (string * Cohttp_lwt.Body.t Wm.acceptor) list,
           Cohttp_lwt.Body.t )
         Wm.op

       method content_types_provided :
         ( (string * Cohttp_lwt.Body.t Wm.provider) list,
           Cohttp_lwt.Body.t )
         Wm.op
     end
...
class virtual html_page :
  server
  -> object
       inherit protected_page

       method virtual private render :
         (CI_web_templates.t -> CI_web_templates.page, Cohttp_lwt.Body.t) Wm.op
